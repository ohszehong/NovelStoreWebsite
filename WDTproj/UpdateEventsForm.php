...
<html lang="en" dir="ltr">
  ...
  <body id="background">
    ...
    <form action="UpdateEvents.php" method="post" enctype="multipart/form-data">
        <div class="inputBox">
          <input type="text" name="EventsTitle" required="required">
          <label>Events Title</label>
        </div>
        <div class="inputBox">
          <label>Events Text</label>
          <br>
          <br>
          <textarea name="EventsText" required="required" id="Text"></textarea>
        </div>
        <div class="inputBox">
          <input type="file" name="EventsImage" required="required">
        </div>
        <input type="submit" name="UpdateEvents" value="Update">
    </form>
    </div>
